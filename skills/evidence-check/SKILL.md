---
description: Ground an empirical scientific or technical claim in real retrieved evidence before answering. Use whenever a scientific, biomedical, clinical, pharmacological, genomic, chemical, materials, energy, physics, or AI/ML claim is asserted, questioned, or written down, including "is it true that X", "does the evidence support X", a pasted abstract or preprint, a claim in a draft the user is writing, or a company's stated result. Use it equally for diligence and review requests, which are the same job under different words: due diligence on a claim, a pitch deck, a startup's science, a grant, a manuscript, or a portfolio company's data; screening, sanity-checking, pressure-testing, poking holes in, or red-teaming a result; whether a finding replicates or is reproducible, whether anything has been retracted or corrected, or what a reviewer would ask. Also use before you cite a paper, trial, or statistic in your own answer, so the citation is retrieved rather than recalled.
---
